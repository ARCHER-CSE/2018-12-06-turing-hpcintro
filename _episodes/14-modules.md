...
```
[{{ site.workshop_host_prompt }} module avail
```
{: .bash}
```
{% include /snippets/14/module_avail.{{ site.workshop_host_id }} %}
```
{: .output}
...
```
{{ site.workshop_host_prompt }} which python3
```
{: .bash}
```
{% include /snippets/14/which_missing.{{ site.workshop_host_id }} %}
```
{: .output}
...
```
{% include /snippets/14/load_python.{{ site.workshop_host_id }} %}
```
{: .bash}
```
{% include /snippets/14/which_python.{{ site.workshop_host_id }} %}
```
{: .output}
...
```
{{ site.workshop_host_prompt }} echo $PATH
```
{: .bash}
```
{% include /snippets/14/path.{{ site.workshop_host_id }} %}
```
{: .output}
...
```
{% include /snippets/14/ls_dir.{{ site.workshop_host_id }} %}
```
{: .bash}
```
{% include /snippets/14/ls_dir_output.{{ site.workshop_host_id }} %}
```
{: .output}
...
{% include /snippets/14/depend_demo.{{ site.workshop_host_id }} %}
...
{% include /snippets/14/gcc_example.{{ site.workshop_host_id }} %}
...
Most HPC systems have a pretty large set of preinstalled software. Nonetheless, it's unlikely that
...
```
{{ site.workshop_host_prompt }} git clone https://github.com/lh3/seqtk.git
```
{: .bash}
```
Cloning into 'seqtk'...
...
```
{{ site.workshop_host_prompt }} cd seqtk
...
```
{{ site.workshop_host_prompt }} ./seqtk
```
{: .bash}
```
